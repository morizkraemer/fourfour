...
- Do not ignore all of `benchmark/`. Track reusable scripts, manifests, docs, and small baselines; ignore local datasets, run results, logs, caches, and downloaded archives.
- Keep batch-analysis scripts raw. They should run the public CLI and write outputs; scoring and comparison belong in a separate review step.
