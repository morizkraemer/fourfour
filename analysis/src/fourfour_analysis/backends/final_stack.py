...
_VERSION = "0.1.0"
_LEXICON_FEATURES_WITHOUT_KEY = {"bpm", "energy", "waveform", "cues"}
...
class FinalStackBackend(AnalysisBackend):
    ...
    def __init__(self, cache_dir: Optional[Path] = None, features: Optional[set[str]] = None):
        ...
        lexicon_features = _LEXICON_FEATURES_WITHOUT_KEY if self._features is None else self._features - {"key"}
        self._lexicon = LexiconPortBackend(cache_dir=None, features=lexicon_features)
